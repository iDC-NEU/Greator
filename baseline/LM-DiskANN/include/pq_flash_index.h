...
#define SECTOR_LEN 4096 * 2
// #define SECTOR_LEN 16384 * 1024
// #define SECTOR_LEN 32768 * 1024
// #define SECTOR_LEN 65536 * 1024
// #define SECTOR_LEN 131072 * 1024
// #define SECTOR_LEN 262144 * 1024
...
namespace diskann {
  ...
  class PQFlashIndex {
   public:
    ...
    DISKANN_DLLEXPORT void compute_pq_dists_by_pq_coords(
        const _u8 *src, _u8 *pq_coords, float *fp_dists, const _u32 count,
    ...
    DISKANN_DLLEXPORT uint64_t get_n_chunks() {
    ...
    void set_num_point(_u64 num_points_) {
   ...
   private:
    ...
    _u8 *pq_centroid_data = nullptr;  // pq_compressed_vector
    ...
    _u8                        *pq_coord_cache_buf = nullptr;
    tsl::robin_map<_u32, T *>   coord_cache;
    tsl::robin_map<_u32, _u8 *> pq_coord_cache;
