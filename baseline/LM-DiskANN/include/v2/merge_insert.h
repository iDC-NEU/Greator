...
// #define MERGE_TH 50  // 0.0001
// #define MERGE_TH 500  // 0.001
// #define MERGE_TH 1000  // 0.002
// #define MERGE_TH 2000  // 0.004
// #define MERGE_TH 3000  // 0.006
// #define MERGE_TH 4000  // 0.008
// #define MERGE_TH 10000  // 0.01
// #define MERGE_TH 994  // 0.0
  ...
  class MergeInsert {
   public:
    ...
    DISKANN_DLLEXPORT MergeInsert(
        ...
        std::string working_folder, uint32_t mt = 1000);
